...
// Instead of matching the end, find the very first return statement and wrap the contents.
client = client.replace(
  /return \(\n\s*<div className="dark:text-white">/,
  `return (\n    <>\n      <Script src="https://checkout.razorpay.com/v1/checkout.js" strategy="lazyOnload" />\n      <div className="dark:text-white">`
);

// To safely close it, match the very last `</div>` before the final `)` or `}`
...
if (!client.includes('Script')) {
  client = `import Script from 'next/script'\n` + client;
}
if (!client.includes('toast')) {
