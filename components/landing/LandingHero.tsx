      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full py-20 md:py-28 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="land-pill mb-8">
            <span className="w-1.5 h-1.5 rounded-full" style={{ background: '#20B26B', animation: 'land-pulse-dot 2s ease-in-out infinite' }} />
        ...
        >
          ...
          >
            <div className="w-2 h-2 rounded-full" style={{ background: '#20B26B', animation: 'land-pulse-dot 2s ease-in-out infinite' }} />
