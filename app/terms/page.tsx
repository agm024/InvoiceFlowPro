...
export const metadata: Metadata = {
  title: 'Terms & Conditions — FlowRadiant',
  description: 'Terms of service governing your use of FlowRadiant.',
}
...
export default function TermsPage() {
  return (
    <LegalLayout title="Terms & Conditions" lastUpdated="August 2026">
      ...
      <p>While we strive for 100% accuracy, FlowRadiant is not liable for any financial losses or damages resulting from calculation errors, delayed invoice generation, or billing discrepancies caused by software bugs or user input. It is the user&apos;s responsibility to verify all outgoing invoices before sending them to clients.</p>
      ...
      <p>We are not responsible for late payments from your clients resulting from missed automated reminders or email delivery failures. FlowRadiant simply acts as a conduit for your communication.</p>
