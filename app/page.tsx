      ...
      <main className="flex-1 flex flex-col items-center">
        ...
        <section className="relative w-full px-6 pt-32 pb-32 max-w-7xl mx-auto flex flex-col items-center text-center">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row gap-4 justify-center items-center w-full sm:w-auto">
            {session ? (
              <Link href={dashboardHref} className="group relative inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-3.5 rounded-full font-semibold transition-all hover:scale-105 shadow-[0_0_40px_-10px_rgba(0,0,0,0.3)] dark:shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]">
        ...
        <section id="features" className="w-full py-32 bg-white dark:bg-[#09090b] relative">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[240px]">
              ...
              {/* Card 5: Wide */}
              <div className="md:col-span-2 md:row-span-1 group relative overflow-hidden bg-primary rounded-3xl border border-zinc-800 dark:border-zinc-200 p-8 text-primary-foreground">
        ...
        <section className="relative w-full py-32 bg-white dark:bg-[#09090b] text-center px-6 overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10">
            ...
            <Link href={dashboardHref} className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-10 py-5 rounded-full font-bold hover:scale-105 transition-transform text-lg shadow-2xl shadow-primary/20 ">
