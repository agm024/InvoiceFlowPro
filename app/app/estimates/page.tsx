              ...
              {estimates.map((estimate) => (
                <tr key={estimate.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
                  <td className="px-6 py-4">
                    <Link href={`/app/estimates/${estimate.id}`} className="font-medium text-zinc-900 dark:text-white hover:underline">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex justify-end gap-2 items-center">
                      <Link href={`/app/estimates/${estimate.id}`} className="text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors p-1" title="View">
                        <FileText size={18} />
                      </Link>
