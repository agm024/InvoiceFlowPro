          ...
          <tbody className="divide-y divide-sidebar-border">
            {invoice.items.map((item) => (
              <tr key={item.id} className="text-foreground">
                ...
                <td className="px-8 py-4 text-zinc-900">{item.quantity}</td>
        ...
        <div className="p-8 bg-sidebar-bg/30 flex justify-end">
          <div className="w-full md:w-72">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className="font-medium text-foreground">{getCurrencySymbol(invoice.currency)} {invoice.subTotal.toFixed(2)}</span>
            </div>
            <div className="flex justify-between items-center text-sm">
