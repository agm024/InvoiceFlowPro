...
export default async function ProductDetailsPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="max-w-7xl mx-auto w-full space-y-10 pt-8 pb-16 px-4 sm:px-6 lg:px-8">
      ...
      {/* Back Link */}
      <div>
        <Link href="/app/products" className="group inline-flex items-center gap-2 text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">
