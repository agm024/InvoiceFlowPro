...
1. SCOPE OF WORK & DELIVERABLES
The Service Provider, operating through its digital division SiteRadiant, agrees to perform design and development services as specified below for the project "<b>${projectName}</b>":
      ...
      <div className="bg-white dark:bg-zinc-900 w-full max-w-2xl rounded-2xl shadow-xl flex flex-col max-h-[90vh] border border-zinc-200 dark:border-zinc-800">
        ...
        >
          <div className="bg-zinc-50 dark:bg-zinc-950/50 p-6 rounded-xl border border-zinc-200 dark:border-zinc-800">
            <div 
              className="whitespace-pre-wrap font-serif text-zinc-800 dark:text-zinc-200"
              dangerouslySetInnerHTML={{ __html: type === 'contract' ? finalContractText.trim() : handoverText.trim() }}
            />
