...
export default async function ProjectDetailPage({ 
  ...
  return (
    <div className="max-w-7xl mx-auto w-full space-y-8 pt-8 pb-16 px-4 sm:px-6 lg:px-8">
      {/* Back Link */}
      <div>
        <Link href="/projects" className="group inline-flex items-center gap-2 text-sm font-medium text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-colors">
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                <span>Client:</span>
                <Link href={`/clients/${project.client.slug}`} className="inline-flex items-center gap-1 text-zinc-900 dark:text-zinc-200 hover:text-blue-600 transition-colors font-bold bg-zinc-100 dark:bg-zinc-800 px-2.5 py-0.5 rounded-md">
